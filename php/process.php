...
if( isset($_POST) ){
    ...
    //date_default_timezone_set("Amercia/Denver");
    //$date = date('d/m/Y');
    //$time = date('H:i:s');
    $date = "date";
    $time = "time";
    ...
    if($formok){
        ...
        $emailbody = "<p>You have recieved a new message from the form on your website.</p>
                      ...
                      <p><strong>Mode of Contact: </strong> {$contactType} </p>
                      <p><strong>Message: </strong> {$message} </p>
                      <p>This message was sent from the IP Address: {$ipaddress} on {$date} at {$time}</p>";
         
        mail("info@breezetech.ca","New Form",$emailbody,$headers);
